...
object AverageTweetLength {
  ...
  def main(args: Array[String]) {
    ...
    var longest_tweet = new AtomicInteger(0)
...
//      })
      ...
      if (count > 0) {
        ...
        if (max_val > longest_tweet.get()){
          longest_tweet.set(max_val)
        }
        ...
        println("Total tweets: " + totalTweets.get() + 
          ...
          "Longest tweet is: " + longest_tweet.get()
        )
      }
    })
